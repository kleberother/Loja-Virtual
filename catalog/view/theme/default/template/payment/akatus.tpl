...
?>
		...
		<link href="catalog/view/theme/default/stylesheet/akatus/estilos.css" rel="stylesheet" type="text/css" />
        ...
        <LI><LABEL><img id='cartao_visa'  src='/catalog/view/theme/default/image/akatus/cartao_visa.gif' ><BR>
        ...
        <LI><label><img id='cartao_master'  src='/catalog/view/theme/default/image/akatus/cartao_master.gif' >
			<BR>
         ...
         <LI><label><img id='cartao_elo'  src='/catalog/view/theme/default/image/akatus/cartao_elo.gif' >
         ...
         <LI><LABEL><img id='cartao_diners'  src='/catalog/view/theme/default/image/akatus/cartao_diners.gif' >
			<BR>
            ...
            <LI><label><img id='cartao_amex'  src='/catalog/view/theme/default/image/akatus/cartao_amex.gif' ><BR>
    ...
    <table width="800" border="0" cellpadding="3" cellspacing="1">
        ...
        <div id="carregando">
        <CENTER>
		<BR><BR><img src="/catalog/view/theme/default/image/carregando.gif" width="220" height="19" />
        </CENTER>
        </div>
...
<P><img src="/catalog/view/theme/default/image/fechar.jpg" width="20" height="20" align="absmiddle" /><a style="color:#F00; font-weight:bold" href="javascript:ocultar_popup()">Clique aqui para fechar</a></P>
...
<p> <img src="/catalog/view/theme/default/image/visa.gif" width="189" height="135" align="left" /><br />
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><img src="/catalog/view/theme/default/image/amex.gif" width="189" height="124" align="left" /><strong>American Express </strong><br />
