...
<table width="700" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      ...
      <?php if ($product) { ?>
      <td valign="top" style="background:#62bc0f;width:168px;text-align:center;">
        <table border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;text-align:center;">
          <tbody>
            <tr>
              <td>
                <a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>" target="_blank"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" width="<?php echo $image_width; ?>" height="<?php echo $image_height; ?>" border="0" style="background:#fff;padding:14px;border-bottom:solid 10px #01404F;"></a>
              </td>
            </tr>
            <tr>
