    ...
    <tr>
      <td style="padding-bottom:12px; padding-top:15px;">
        <table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
          <tbody>
            <tr>
              <td style="color:<?php echo $heading_color; ?>;<?php echo $heading_style; ?>"><span style="display:block;padding-top:15px;height:25px;"><?php echo $heading; ?></span></td>
            </tr>
          </tbody>
        </table>
      </td>
...
<table width="700" border="0" cellspacing="0" cellpadding="0">
  <tbody>
    ...
    <tr>
      ...
      <?php if ($product) { ?>
      <td valign="top" style="border:1px <?php echo $description_color; ?> dashed;width:168px;text-align:center;">
        <table border="0" cellspacing="0" cellpadding="0" style="margin:0 auto;text-align:center;">
          <tbody>
            <tr>
              <td style="padding-top:13px;">
                <a href="<?php echo $product['href']; ?>" title="<?php echo $product['name']; ?>" target="_blank"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" width="<?php echo $image_width; ?>" height="<?php echo $image_height; ?>" border="0" style="-moz-box-shadow: 0px 3px 5px 5px #ccc;-webkit-box-shadow: 0px 3px 5px 5px #ccc;box-shadow: 0px 3px 5px 5px #ccc;border:1px #ccc solid;"></a>
              </td>
            </tr>
            <tr>
