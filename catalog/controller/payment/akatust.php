...
class ControllerPaymentakatust extends Controller 
{
  protected function index() 
  {
	...
	$this->data['desconto'] = $this->config->get('akatust_desconto');
    ...
    $this->id = 'payment';
    if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/akatust.tpl')) {
	  $this->template = $this->config->get('config_template') . '/template/payment/akatust.tpl';
	} else {
	  $this->template = 'default/template/payment/akatust.tpl';
	}	
	$this->render();
  }
